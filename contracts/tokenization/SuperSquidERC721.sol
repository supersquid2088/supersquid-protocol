    ...
    MinterAccessControl
{
    ...
    mapping(address => uint256) private address2Price;
    ...
    function claim(
        ...
        uint256 price = address2Price[_tokenAddress];
        require(price > 0, "address error");
        require(_tokenAmount >= price * _nftAmount, "msg.value is incorrect");
        ...
        //transferFrom userAddress to tokenReceiverAddress
        IERC20 erc20 = IERC20(_tokenAddress);
        erc20.transferFrom(_msgSender(), tokenReceiverAddress, _tokenAmount);
    }
    ...
    function setPrice(uint256 _mintPrice, address _tokenAddress)
        public
        onlyOwner
    {
        require(
        ...
        address2Price[_tokenAddress] = _mintPrice;
    }

    function setTokenReceiverAddress(address _tokenReceiverAddress)
        public
        onlyOwner
    {
    ...
    function getPrice(address _tokenAddress) public view returns (uint256) {
        return address2Price[_tokenAddress];
    }
    ...
    function getTokenReceiverAddress() public view returns (address) {
